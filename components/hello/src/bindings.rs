        ...
        pub mod monotonic_clock {
            ...
            pub fn now() -> Instant {
                unsafe {
                    ...
                    #[link(wasm_import_module = "wasi:clocks/monotonic-clock@0.2.7")]
                    unsafe extern "C" {
                        #[link_name = "now"]
                        fn wit_import0() -> i64;
                    }
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Fields {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:http/types@0.2.7")]
                        unsafe extern "C" {
        ...
        pub mod poll {
            ...
            unsafe impl _rt::WasmResource for Pollable {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/poll@0.2.7")]
                        unsafe extern "C" {
        ...
        pub mod error {
            ...
            unsafe impl _rt::WasmResource for Error {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/error@0.2.7")]
                        unsafe extern "C" {
        ...
        pub mod streams {
            ...
            unsafe impl _rt::WasmResource for InputStream {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "wasi:io/streams@0.2.7")]
                        unsafe extern "C" {
    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod incoming_handler {
                ...
                #[doc(hidden)]
                macro_rules! __export_wasi_http_incoming_handler_0_2_7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wasi:http/incoming-handler@0.2.7#handle")] unsafe extern "C" fn
                ...
                #[doc(hidden)]
                pub(crate) use __export_wasi_http_incoming_handler_0_2_7_cabi;
            }
        }
    }
}
...
macro_rules! __export_hello_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::http::incoming_handler::__export_wasi_http_incoming_handler_0_2_7_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:hello:component:hello:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6336] = *b"\
...
\0\x12wasi:io/poll@0.2.7\x05\0\x02\x03\0\0\x08pollable\x01B\x0f\x02\x03\x02\x01\x01\
...
otonic-clock@0.2.7\x05\x02\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04se\
lf\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x13wasi:io/error@\
0.2.7\x05\x03\x02\x03\0\x02\x05error\x01B(\x02\x03\x02\x01\x04\x04\0\x05error\x03\
...
2.7\x05\x05\x02\x03\0\x01\x08duration\x02\x03\0\x03\x0cinput-stream\x02\x03\0\x03\
...
e\x01\x8d\x01\x03\0\x15wasi:http/types@0.2.7\x05\x09\x02\x03\0\x04\x10incoming-r\
...
ndle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.7\x05\x0c\x04\0\x15hello:co\
mponent/hello\x04\0\x0b\x0b\x01\0\x05hello\x03\0\0\0G\x09producers\x01\x0cproces\
